...
decimal[] q2Sales = [89.99m, 76.50m, 98.75m, 120.00m];
decimal[] q3Sales = [105.60m, 99.99m, 92.45m];
decimal[] q4Sales = [67.89m, 80.00m, 115.25m, 108.40m, 130.00m];
decimal[] combinedData = CombineSalesAndBonuses(q1Sales, q2Sales, q3Sales, q4Sales);

Console.WriteLine(string.Join(",", combinedData));
